...
This vignette provides a demonstration of how to use the *trustOptim* package
to estimate an objective function with a sparse Hessian. Most of the
vignette was originally published as @R_trustOptim.  This version
contains less comparison with other optimization methods, and less of
the underlying theory of trust region methods.  Nevertheless, please
cite @R_trustOptim when using this package in your own research.
...
function in the base *R* distribution, and many others are described
...
**R** matrix.  Some conjugate gradient and limited memory methods, (e.g., *L-BFGS*,
...
problems. However, they are not certain to
...
Hessians.  The details of the trust region algorithm are included at
