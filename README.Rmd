...
The package is available on CRAN.  A development version is available
at github.com/braunm/trustOptim.

# Using the package

The `trust.optim` function calls the optimizer.  See the vignettes for
